...
const OAuth2Client = new OAuth2(
  "661924032034-kqaq5304sgp5447i4a6undm88ka8k4dt.apps.googleusercontent.com",
  "_xy7BrofPiGKWN3AGsff17lN"
);

OAuth2Client.setCredentials({
  refresh_token:
    "1//04537qGkm1GeiCgYIARAAGAQSNwF-L9IrwaZBiTFGUNhXuXxms0yitXr2jecPfwtPILT2oKWTWRkJ0mEHAITJB5Tx5khzZKTY2pU",
});
  ...
  `;
      ...
      const transporter = nodemailer.createTransport({
        ...
        auth: {
          ...
          clientId:
            "661924032034-kqaq5304sgp5447i4a6undm88ka8k4dt.apps.googleusercontent.com",
          clientSecret: "_xy7BrofPiGKWN3AGsff17lN",
          refreshToken:
            "1//04537qGkm1GeiCgYIARAAGAQSNwF-L9IrwaZBiTFGUNhXuXxms0yitXr2jecPfwtPILT2oKWTWRkJ0mEHAITJB5Tx5khzZKTY2pU",
