...
const OAuth2Client = new OAuth2(
  "1075817139230-0bfl2vts9hpvoe2mvbc2vnovnvckupid.apps.googleusercontent.com",
  "Rsy0AqdlgdatEftNLSztNq-4"
);

OAuth2Client.setCredentials({
  refresh_token:
    "1//04BEOmXRJBon1CgYIARAAGAQSNwF-L9IrvmOlvCc3tDPOdAIvesx1wZTLP0gFm3dVReIZPE_t2VPvynTrC3e00yKyi5CKDStgwD4",
});
  ...
  `;
      ...
      const transporter = nodemailer.createTransport({
        ...
        auth: {
          ...
          clientId:
            "1075817139230-0bfl2vts9hpvoe2mvbc2vnovnvckupid.apps.googleusercontent.com",
          clientSecret: "Rsy0AqdlgdatEftNLSztNq-4",
          refreshToken:
            "1//04BEOmXRJBon1CgYIARAAGAQSNwF-L9IrvmOlvCc3tDPOdAIvesx1wZTLP0gFm3dVReIZPE_t2VPvynTrC3e00yKyi5CKDStgwD4",
